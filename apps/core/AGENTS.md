...
- a channel record **narrow and add, never grant**. `applyChannelRecord` is the one seam. do not let it hand out capability the agent lack, or reading an agent stop telling you its ceiling.
