...
function CanvasControls() {
  ...
  return (
    <div className="flex flex-col rounded-lg border border-white/[0.06] bg-[#141414]/80 p-0.5 backdrop-blur-md">
      ...
      <div className="mx-1.5 my-0.5 border-t border-white/[0.06]" />
