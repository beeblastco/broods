...
type MergedBin = ReturnType<typeof mergeByBucket>[number];
...
const TOKEN_SERIES: Array<ChartSeries<keyof MergedBin>> = [
...
const SANDBOX_CPU_SERIES: Array<ChartSeries<keyof MergedBin>> = [
  {
