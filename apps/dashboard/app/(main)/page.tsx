...
function CanvasControls() {
    ...
    const btn =
        "flex h-7 w-7 items-center justify-center rounded-md text-white/30 transition-colors hover:bg-white/4 hover:text-white/60";

    return (
        <div className="flex flex-col rounded-lg border border-white/10 bg-[#141414]/80 p-0.5 backdrop-blur-md">
            ...
            <div className="mx-1.5 my-0.5 border-t border-white/10" />
...
/** Main canvas with ReactFlow nodes and edges. */
function Canvas() {
    ...
    const addAgentNode = useCallback(() => {
        ...
        const newNode: Node = {
            ...
            data: { label: `Agent ${id}`, status: "idle" },
        };
    ...
    return (
        <ContextMenu>
            ...
            <ContextMenuContent>
                <ContextMenuLabel className="text-xs tracking-wider text-muted-foreground">Add service</ContextMenuLabel>
                <ContextMenuItem onClick={addAgentNode}>
                    <Bot />
                    Agent
                </ContextMenuItem>
            </ContextMenuContent>
