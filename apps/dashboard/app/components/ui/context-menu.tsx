...
> {
  className?: string;
  inset?: boolean;
  /** `locked` is a disabled row that keeps its full colour; the caller adds the lock. */
  variant?: "default" | "destructive" | "locked";
}
