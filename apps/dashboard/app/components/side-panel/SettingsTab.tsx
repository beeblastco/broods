...
> = {
  ...
  workspace: {
    ...
    detail:
      "The canvas reference will be removed. The underlying workspaceConfig record is not deleted from the account API.",
  },
  sandbox: {
    summary: "Remove this sandbox reference from the canvas.",
    detail:
      "The canvas reference will be removed. The underlying sandboxConfig record is not deleted from the account API.",
  },
  skill: {
