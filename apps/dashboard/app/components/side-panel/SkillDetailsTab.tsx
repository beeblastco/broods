...
export function SkillDetailsTab({
  ...
  function setActive(next: boolean) {
    ...
    void updateBranch(
      ["skills"],
      Object.keys(nextSkills).length > 0 ? nextSkills : undefined,
    );
  }
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="rounded-lg border border-dashed border-border bg-muted/20 px-3 py-4 text-center">
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">
              ...
              <code className="rounded bg-muted px-1">SKILL.md</code> at the
              root, then publish.
            </p>
          </div>
          {path && (
