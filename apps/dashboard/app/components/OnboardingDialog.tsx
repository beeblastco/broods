...
function HexSteps({ step, count }: { step: number; count: number }) {
    return (
        <div className="flex items-center gap-1" aria-label={`Step ${step + 1} of ${count}`}>
            ...
            >
                ...
                >
                    {step === 0 && (
                        <div className="grid gap-3 text-sm leading-relaxed text-muted-foreground">
                            <p>
                                Broods runs agents as configuration: declare agents, workspaces, and
                                crons in a <Mono>broods/</Mono> folder, and the platform deploys and
                                operates them for you.
                            </p>
                            <p>
                                This dashboard is where you watch and steer everything — architecture,
                                runs, sandboxes, and schedules. Two quick things first.
                            </p>
                        </div>
                    )}
                    ...
                    {step === 1 && (
                        <div className="grid gap-3">
                            ...
                            <p className="text-xs leading-relaxed text-muted-foreground">
                                This secret is how you manage your account and resources through the
                                API — provisioning agents, crons, and workspaces straight from your
                                own code.
                            </p>
                            <div className="flex items-center gap-4">
                                <DocsLink href="https://docs.broods.app/sdk">Use it from the SDK</DocsLink>
                                <DocsLink href="https://docs.broods.app/api-reference">API reference</DocsLink>
                            </div>
                        </div>
                    )}
                    ...
                    {step === 2 && (
                        <div className="grid gap-3">
                            ...
                            <p className="text-xs leading-relaxed text-muted-foreground">
                                ...
                                config in sync while it runs. Once it&apos;s up, <Mono>broods-demo</Mono>{" "}
                                appears on your projects page.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="flex items-center justify-between pt-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {step < 2 ? (
                            <Button size="sm" className="cursor-pointer" onClick={() => setStep(step + 1)}>
                                Continue
                            </Button>
                        ) : (
