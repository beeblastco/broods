...
const SOURCE_OPTIONS = [
    { key: "files" as SkillSource, label: "Upload files", icon: FolderOpen, description: "Manage skill files locally and publish to your account." },
    { key: "github" as SkillSource, label: "GitHub repository", icon: GitBranch, description: "Import directly from a GitHub repository URL." },
    { key: "json" as SkillSource, label: "Quick create", icon: Sparkles, description: "Write a skill with name, description, and instructions." },
] as const;
