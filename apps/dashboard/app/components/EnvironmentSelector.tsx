...
export function EnvironmentSelector() {
    ...
    const [duplicateFromId, setDuplicateFromId] = useState<Id<"environments"> | null>(null);
    ...
    async function handleCreate() {
        ...
        try {
            const newId = await createEnvironment({
                projectId: projectId,
                name: newName.trim(),
                duplicateFromId: createMode === "duplicate" && duplicateFromId ? duplicateFromId : undefined,
            });
