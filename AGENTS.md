...
- dashboard also loads `@shadcn/lint` (oxlint JS plugin, `jsPlugins` in the `apps/dashboard/**` override) for design system rules. what each rule enforces there: `apps/dashboard/AGENTS.md`.
