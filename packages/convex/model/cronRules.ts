 ...
 */
export function toCronRunResponse(doc: Doc<"cronRuns">): Record<string, unknown> {
    return {
        accountId: doc.accountId,
        cronId: doc.cronId,
        runId: doc._id,
...
function runPayloadToEvents(payload: { input?: unknown; events?: unknown }): unknown[] {
...
function optionalRunPayloadToEvents(payload: { input?: unknown; events?: unknown }): unknown[] | undefined {
