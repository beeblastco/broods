...
export async function writeGeneratedFiles(
  ...
  await writeFile(
    resolve(dir, "api.ts"),
    apiFile(manifest, scopedIds, aliases, endpoint, channels),
    "utf8",
  );
  await writeFile(
    resolve(dir, "resources.ts"),
    resourcesFile(manifest),
    "utf8",
  );
  await writeFile(resolve(dir, "dataModel.ts"), dataModelFile(), "utf8");
}

function idsForManifest(
  ids: GeneratedIds,
  manifest: CliManifest,
): GeneratedIds {
  const namesByKind = {
...
function apiFile(
  ...
  return (
    `// Generated by broods. Do not edit by hand.\n` +
    `import type { ResourceApi } from "broods";\n` +
    `import { ids } from "./ids";\n\n` +
    `/** Typed references for resources defined in broods/. */\n` +
    `export const api = {\n` +
    `  agents: {\n${agentEntries}\n  },\n` +
    `  channels: {\n${channelEntries}\n  },\n` +
...
function dataModelFile(): string {
  return (
    `// Generated by broods. Do not edit by hand.\n` +
    `export type { AgentReference, ChannelReference, AgentRunInput, AgentRunResult, ResourceApi } from "broods";\n`
  );
}
