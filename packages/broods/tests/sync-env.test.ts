...
test("listEnv GETs the env collection and returns variable names", async () => {
  ...
  expect(calls[0]).toEqual({
    url: "https://control.example.com/api/cli/projects/demo-app/environments/development/env",
    method: "GET",
  });
});
...
test("getRuntimeKey recovers the environment runtime key", async () => {
  ...
  expect(calls[0]).toEqual({
    url: "https://control.example.com/api/cli/projects/demo-app/environments/development/runtime-key",
    method: "GET",
  });
});
...
test("getEnv GETs the named env var and returns its value", async () => {
  ...
  expect(calls[0]).toEqual({
    url: "https://control.example.com/api/cli/projects/demo-app/environments/development/env/OPENAI_API_KEY",
    method: "GET",
  });
});
