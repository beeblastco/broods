...
- `ZALO_BOT_NAME`: name the agent answers to in group chats. Group messages without it are kept as context instead of running the agent. Unset means every group message runs the agent.
