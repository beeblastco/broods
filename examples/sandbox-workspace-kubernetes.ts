...
const visualizationAgent = await createAgent(account.secret, "Kubernetes workspace visualization assistant", {
  ...
  agent: {
    system: [
      ...
      "Read analysis artifacts created by another agent from the shared workspace before writing code.",
    ...
    events: [
      {
        ...
        content: [{
          ...
          text: [
            ...
            "   the input files, chart type, output file sizes, and top performers.",
